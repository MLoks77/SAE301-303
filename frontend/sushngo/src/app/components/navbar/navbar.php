        ...
        <div class="flex flex-col h-full pt-8 px-6 gap-6">
            ...
            <?php
                ...
                if (isset($_SESSION["logged_in"]) && $_SESSION["logged_in"] === true) {
                    echo    '<a routerLink="/compte" (click)="closeMenu()" class="py-3 px-2 flex items-center transition-opacity duration-100 hover:opacity-60">
                    ...
                    echo    '<a routerLink="/inscription-connexion" (click)="closeMenu()" class="py-3 px-2 flex items-center transition-opacity duration-100 hover:opacity-60">
                                <svg viewBox="0 0 24 24" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" fill="#000000" class="w-7 h-7 mr-2">
                                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                    <g id="SVGRepo_iconCarrier">
